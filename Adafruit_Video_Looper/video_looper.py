#  This is a quick upgrade to the Adafruit Video Looper main code to support some of our models
#  Big thanks, kudos & original credits goes to the guy right below ;P
...
# - https://stackoverflow.com/questions/21356439/how-to-load-and-play-a-video-in-pygame -> tryout to display nice animation while no storage found
