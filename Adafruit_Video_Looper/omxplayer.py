...
class OMXPlayer(object):
    ...
    def play(self, movie, loop=False, vol=0):
        ...
        # == Tef edit ==
        # also redirect the process stdin to a fifo we control to be able to send it keystroke as 'echo -n q > /home/pi/omxfifo'
        '''
        self._process = subprocess.Popen(args,
                                         stdin=open('/home/pi/omxfifo', 'rb'), # TO TEST BEFORE USE ! ;p
